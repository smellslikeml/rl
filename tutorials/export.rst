...
.. GENERATED FROM PYTHON SOURCE LINES 50-144
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmplazor5h6/model.pt2
    tensor(1)
...
.. image-sg:: /tutorials/images/sphx_glr_export_001.png
   :alt: Screen rendering of Pong game.
   :srcset: /tutorials/images/sphx_glr_export_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 411-465
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 624.5620 msec (total =  0.6246 sec since last reset).
    TorchRL version took 1799.0491 msec (total =  1.7990 sec since last reset).




.. GENERATED FROM PYTHON SOURCE LINES 466-492
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 23.034 seconds)
