...
```
The buffer has 3 elements
the 'a' tensor is stored in /tmp/tmp41vxcz4i/a.memmap
the ('b', 'c') tensor is stored in /tmp/tmp41vxcz4i/b/c.memmap
...
```
tensor([0, 0, 2, 2, 2, 0, 1, 1, 0, 0, 0, 1])
```
...
[DataCollector](../reference/collectors.html#ref-collectors), the trajectory id is stored in
...
```
episode are grouped tensor([1, 1, 4, 4, 3, 3, 4, 4], dtype=torch.int32)
...
[Trajectory boundaries](../reference/data_layout.html#ref-traj-boundaries) spells out the full
