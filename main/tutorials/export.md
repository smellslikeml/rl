...
```
pkg_path /tmp/tmpd_e1gnnr/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 622.4487 msec (total = 0.6224 sec since last reset).
TorchRL version took 1830.6615 msec (total = 1.8307 sec since last reset).
```
