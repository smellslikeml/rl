...
```
pkg_path /tmp/tmpuddc_g65/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.5465 msec (total = 0.6245 sec since last reset).
TorchRL version took 1865.0897 msec (total = 1.8651 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.167 seconds)
