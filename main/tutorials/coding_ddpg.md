...
## TorchRL [`LossModule`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule)
...
The parent class of all losses is [`LossModule`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule).
As many other components of the library, its [`forward()`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule.forward) method expects
...
[`convert_to_functional()`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule.convert_to_functional). This method will extract
...
argument tells the [`convert_to_functional()`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule.convert_to_functional)
...
[`ValueEstimators`](../reference/generated/torchrl.objectives.ValueEstimators.html#torchrl.objectives.ValueEstimators) Enum class, which contains
...
not, the [`LossModule`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule) will query this method with
...
base environment in a specialized [`TransformedEnv`](../reference/generated/torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv) class.
...
to single precision.
The [`DoubleToFloat`](../reference/generated/torchrl.envs.transforms.DoubleToFloat.html#torchrl.envs.transforms.DoubleToFloat) transform does exactly this: the
...
- We concatenate the state keys together using the [`CatTensors`](../reference/generated/torchrl.envs.transforms.CatTensors.html#torchrl.envs.transforms.CatTensors)
transform.
...
The Q-Value network is wrapped in a [`ValueOperator`](../reference/generated/torchrl.modules.ValueOperator.html#torchrl.modules.ValueOperator)
...
original paper. These can be found under [`DdpgMlpActor`](../reference/generated/torchrl.modules.DdpgMlpActor.html#torchrl.modules.DdpgMlpActor)
and [`DdpgMlpQNet`](../reference/generated/torchrl.modules.DdpgMlpQNet.html#torchrl.modules.DdpgMlpQNet).
...
The policy is passed into a [`OrnsteinUhlenbeckProcessModule`](../reference/generated/torchrl.modules.OrnsteinUhlenbeckProcessModule.html#torchrl.modules.OrnsteinUhlenbeckProcessModule)
...
Here we use [`Collector`](../reference/generated/torchrl.collectors.Collector.html#torchrl.collectors.Collector), TorchRL's main collector
...
of registering a new [`StepCounter`](../reference/generated/torchrl.envs.transforms.StepCounter.html#torchrl.envs.transforms.StepCounter) transform
...
0%| | 0/10000 [00:00<?, ?it/s]
 8%|▊ | 800/10000 [00:00<00:03, 2374.90it/s]
 16%|█▌ | 1600/10000 [00:01<00:11, 734.70it/s]
 24%|██▍ | 2400/10000 [00:02<00:06, 1098.59it/s]
 32%|███▏ | 3200/10000 [00:02<00:04, 1435.86it/s]
 40%|████ | 4000/10000 [00:02<00:03, 1724.32it/s]
 48%|████▊ | 4800/10000 [00:03<00:02, 1968.94it/s]
 56%|█████▌ | 5600/10000 [00:03<00:02, 2119.33it/s]
reward: -2.23 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.26/6.44, grad norm= 81.51, loss_value= 464.74, loss_actor= 14.61, target value: -15.59: 56%|█████▌ | 5600/10000 [00:05<00:02, 2119.33it/s]
reward: -2.23 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.26/6.44, grad norm= 81.51, loss_value= 464.74, loss_actor= 14.61, target value: -15.59: 64%|██████▍ | 6400/10000 [00:05<00:04, 793.92it/s]
reward: -1.91 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.84/6.04, grad norm= 127.29, loss_value= 479.69, loss_actor= 15.74, target value: -17.90: 64%|██████▍ | 6400/10000 [00:07<00:04, 793.92it/s]
reward: -1.91 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.84/6.04, grad norm= 127.29, loss_value= 479.69, loss_actor= 15.74, target value: -17.90: 72%|███████▏ | 7200/10000 [00:08<00:04, 562.12it/s]
reward: -4.84 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.33/5.52, grad norm= 163.02, loss_value= 300.03, loss_actor= 18.55, target value: -15.33: 72%|███████▏ | 7200/10000 [00:09<00:04, 562.12it/s]
reward: -4.84 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.33/5.52, grad norm= 163.02, loss_value= 300.03, loss_actor= 18.55, target value: -15.33: 80%|████████ | 8000/10000 [00:10<00:04, 469.07it/s]
reward: -4.84 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.57/5.27, grad norm= 120.46, loss_value= 257.87, loss_actor= 20.88, target value: -17.50: 80%|████████ | 8000/10000 [00:12<00:04, 469.07it/s]
reward: -4.84 (r0 = -2.24), reward eval: reward: -0.01, reward normalized=-2.57/5.27, grad norm= 120.46, loss_value= 257.87, loss_actor= 20.88, target value: -17.50: 88%|████████▊ | 8800/10000 [00:12<00:02, 421.29it/s]
reward: -4.90 (r0 = -2.24), reward eval: reward: -4.79, reward normalized=-3.04/4.55, grad norm= 147.15, loss_value= 190.56, loss_actor= 17.34, target value: -20.34: 88%|████████▊ | 8800/10000 [00:15<00:02, 421.29it/s]
reward: -4.90 (r0 = -2.24), reward eval: reward: -4.79, reward normalized=-3.04/4.55, grad norm= 147.15, loss_value= 190.56, loss_actor= 17.34, target value: -20.34: 96%|█████████▌| 9600/10000 [00:16<00:01, 330.21it/s]
reward: -1.33 (r0 = -2.24), reward eval: reward: -4.79, reward normalized=-2.44/5.28, grad norm= 208.19, loss_value= 265.41, loss_actor= 15.94, target value: -16.52: 96%|█████████▌| 9600/10000 [00:18<00:01, 330.21it/s]
reward: -1.33 (r0 = -2.24), reward eval: reward: -4.79, reward normalized=-2.44/5.28, grad norm= 208.19, loss_value= 265.41, loss_actor= 15.94, target value: -16.52: : 10400it [00:19, 301.50it/s]
reward: -5.05 (r0 = -2.24), reward eval: reward: -4.79, reward normalized=-3.40/5.98, grad norm= 285.57, loss_value= 440.26, loss_actor= 21.46, target value: -23.75: : 10400it [00:21, 301.50it/s]
```
...
![coding ddpg](../_images/sphx_glr_coding_ddpg_001.png)
...
- How to use the [`LossModule`](../reference/generated/torchrl.objectives.LossModule.html#torchrl.objectives.LossModule) class to code up a new
loss component;
...
**Total running time of the script:** (0 minutes 28.888 seconds)

[`Download Jupyter notebook: coding_ddpg.ipynb`](../_downloads/7ef773e36507adbc389133424f663224/coding_ddpg.ipynb)

[`Download Python source code: coding_ddpg.py`](../_downloads/0dfdb6ef4cc9782fdb39c4a9d0900d37/coding_ddpg.py)

[`Download zipped: coding_ddpg.zip`](../_downloads/081100bf3a52dc1a4dc24370cc84af82/coding_ddpg.zip)
