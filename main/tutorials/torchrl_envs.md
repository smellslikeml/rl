...
```
<matplotlib.image.AxesImage object at 0x7f8c925c9c90>
```
...
![torchrl envs](../_images/sphx_glr_torchrl_envs_002.png)
...
For [`SerialEnv`](../reference/generated/torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) and [`ParallelEnv`](../reference/generated/torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv),
...
```
'bar_0dafd582-9fcb-11f1-8fae-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7f8c886b3690>
```
...
```
['bar_0f4feec2-9fcb-11f1-b7bb-0242ac110002', 'bar_0f474786-9fcb-11f1-aaa0-0242ac110002', 'bar_0f5005b0-9fcb-11f1-815a-0242ac110002']
```
...
![torchrl envs](../_images/sphx_glr_torchrl_envs_003.png)
...
![torchrl envs](../_images/sphx_glr_torchrl_envs_004.png)
...
```
mean: : tensor([0.2858, 0.1682, 0.0398])
std: : tensor([1.2881, 1.2511, 1.1895])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([0.0921, 0.0097, 0.0628])
std: : tensor([1.1996, 1.2145, 1.1666])
```
...
**Total running time of the script:** (0 minutes 25.205 seconds)

[`Download Jupyter notebook: torchrl_envs.ipynb`](../_downloads/3cb02b3346194d0f8cfea19dd5243c89/torchrl_envs.ipynb)

[`Download Python source code: torchrl_envs.py`](../_downloads/288f73ca9f77788ef06523e8d93dd58b/torchrl_envs.py)

[`Download zipped: torchrl_envs.zip`](../_downloads/6788515c42b2ed1b56a3c1a2f0fce644/torchrl_envs.zip)
