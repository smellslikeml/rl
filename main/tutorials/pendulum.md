...
its shape (`batch_size`), its methods (mainly [`step()`](../reference/generated/torchrl.envs.EnvBase.html#id4),
[`reset()`](../reference/generated/torchrl.envs.EnvBase.html#id1) and [`set_seed()`](../reference/generated/torchrl.envs.EnvBase.html#id3))
...
[`EnvBase`](../reference/generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) class has a [`EnvBase.step`](../reference/generated/torchrl.envs.EnvBase.html#id4)
...
Next, the [`step()`](../reference/generated/torchrl.envs.EnvBase.html#id4) method will merge the output
of [`step()`](../reference/generated/torchrl.envs.EnvBase.html#id4) in the input `tensordict` to enforce
...
[`reset()`](../reference/generated/torchrl.envs.EnvBase.html#id1)). In some contexts, it is required that
...
The parent [`EnvBase.reset`](../reference/generated/torchrl.envs.EnvBase.html#id1) does some simple checks like the
[`EnvBase.step`](../reference/generated/torchrl.envs.EnvBase.html#id4) does, such as making sure that a `"done"` state
...
Until v0.15, passing a state-bearing `tensordict` to `reset`
...
- `EnvBase.observation_spec`: This will be a [`Composite`](../reference/generated/torchrl.data.Composite.html#torchrl.data.Composite)
instance where each key is an observation (a [`Composite`](../reference/generated/torchrl.data.Composite.html#torchrl.data.Composite) can be
...
TorchRL offers multiple [`TensorSpec`](../reference/generated/torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)
[subclasses](../reference/data_specs.html#ref-specs) to
...
## Wrapping things together: the [`EnvBase`](../reference/generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) class
...
TorchRL provides a simple function [`check_env_specs()`](../reference/generated/torchrl.envs.check_env_specs.html#torchrl.envs.check_env_specs)
...
[`TransformedEnv`](../reference/generated/torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv). The structure of the class allows to
customize the behavior in the different contexts.

A [`Transform`](../reference/generated/torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform) skeleton can be summarized as follows:
...
These operations have been conveniently wrapped in the [`rollout()`](../reference/generated/torchrl.envs.EnvBase.html#id2)
...
data from rollout: TensorDict(
 ...
 max_speed: Tensor(shape=torch.Size([100]), device=cpu, dtype=torch.float32, is_shared=False),
...
dynamically and this is not supported by [`rollout()`](../reference/generated/torchrl.envs.EnvBase.html#id2):
...
rollout of len 3 (batch size of 10): TensorDict(
 ...
 max_speed: Tensor(shape=torch.Size([10, 3]), device=cpu, dtype=torch.float32, is_shared=False),
...
![returns, last reward](../_images/sphx_glr_pendulum_001.png)

```
0%| | 0/31 [00:00<?, ?it/s]
reward: -6.4381, last reward: -6.6717, gradient norm: 7.013: 0%| | 0/31 [00:00<?, ?it/s]
reward: -6.4381, last reward: -6.6717, gradient norm: 7.013: 3%|▎ | 1/31 [00:00<00:04, 6.91it/s]
reward: -6.2590, last reward: -6.5361, gradient norm: 2.55: 3%|▎ | 1/31 [00:00<00:04, 6.91it/s]
reward: -6.2590, last reward: -6.5361, gradient norm: 2.55: 6%|▋ | 2/31 [00:00<00:04, 6.82it/s]
reward: -6.1138, last reward: -6.1229, gradient norm: 3.929: 6%|▋ | 2/31 [00:00<00:04, 6.82it/s]
reward: -6.1138, last reward: -6.1229, gradient norm: 3.929: 10%|▉ | 3/31 [00:00<00:04, 6.83it/s]
reward: -6.1932, last reward: -7.0100, gradient norm: 6.44: 10%|▉ | 3/31 [00:00<00:04, 6.83it/s]
reward: -6.1932, last reward: -7.0100, gradient norm: 6.44: 13%|█▎ | 4/31 [00:00<00:03, 6.84it/s]
reward: -6.5832, last reward: -4.3353, gradient norm: 3.126: 13%|█▎ | 4/31 [00:00<00:03, 6.84it/s]
reward: -6.5832, last reward: -4.3353, gradient norm: 3.126: 16%|█▌ | 5/31 [00:00<00:03, 6.86it/s]
reward: -6.7391, last reward: -4.1995, gradient norm: 2.576: 16%|█▌ | 5/31 [00:00<00:03, 6.86it/s]
reward: -6.7391, last reward: -4.1995, gradient norm: 2.576: 19%|█▉ | 6/31 [00:00<00:03, 6.87it/s]
reward: -6.8264, last reward: -5.2494, gradient norm: 7.198: 19%|█▉ | 6/31 [00:01<00:03, 6.87it/s]
reward: -6.8264, last reward: -5.2494, gradient norm: 7.198: 23%|██▎ | 7/31 [00:01<00:03, 6.88it/s]
reward: -6.7867, last reward: -5.3624, gradient norm: 4.171: 23%|██▎ | 7/31 [00:01<00:03, 6.88it/s]
reward: -6.7867, last reward: -5.3624, gradient norm: 4.171: 26%|██▌ | 8/31 [00:01<00:03, 6.88it/s]
reward: -6.9220, last reward: -4.8760, gradient norm: 1.766: 26%|██▌ | 8/31 [00:01<00:03, 6.88it/s]
reward: -6.9220, last reward: -4.8760, gradient norm: 1.766: 29%|██▉ | 9/31 [00:01<00:03, 6.88it/s]
reward: -6.6887, last reward: -5.4955, gradient norm: 21.92: 29%|██▉ | 9/31 [00:01<00:03, 6.88it/s]
reward: -6.6887, last reward: -5.4955, gradient norm: 21.92: 32%|███▏ | 10/31 [00:01<00:03, 6.88it/s]
reward: -6.7179, last reward: -4.7035, gradient norm: 3.056: 32%|███▏ | 10/31 [00:01<00:03, 6.88it/s]
reward: -6.7179, last reward: -4.7035, gradient norm: 3.056: 35%|███▌ | 11/31 [00:01<00:02, 6.86it/s]
reward: -6.5741, last reward: -4.2936, gradient norm: 2.083: 35%|███▌ | 11/31 [00:01<00:02, 6.86it/s]
reward: -6.5741, last reward: -4.2936, gradient norm: 2.083: 39%|███▊ | 12/31 [00:01<00:02, 6.86it/s]
reward: -6.7024, last reward: -4.7707, gradient norm: 1.039: 39%|███▊ | 12/31 [00:01<00:02, 6.86it/s]
reward: -6.7024, last reward: -4.7707, gradient norm: 1.039: 42%|████▏ | 13/31 [00:01<00:02, 6.85it/s]
reward: -6.3238, last reward: -5.9996, gradient norm: 14.73: 42%|████▏ | 13/31 [00:02<00:02, 6.85it/s]
reward: -6.3238, last reward: -5.9996, gradient norm: 14.73: 45%|████▌ | 14/31 [00:02<00:02, 6.85it/s]
reward: -6.2495, last reward: -7.7481, gradient norm: 3.358: 45%|████▌ | 14/31 [00:02<00:02, 6.85it/s]
reward: -6.2495, last reward: -7.7481, gradient norm: 3.358: 48%|████▊ | 15/31 [00:02<00:02, 6.85it/s]
reward: -6.3425, last reward: -8.7920, gradient norm: 14.18: 48%|████▊ | 15/31 [00:02<00:02, 6.85it/s]
reward: -6.3425, last reward: -8.7920, gradient norm: 14.18: 52%|█████▏ | 16/31 [00:02<00:02, 6.83it/s]
reward: -6.0427, last reward: -9.2459, gradient norm: 4.408: 52%|█████▏ | 16/31 [00:02<00:02, 6.83it/s]
reward: -6.0427, last reward: -9.2459, gradient norm: 4.408: 55%|█████▍ | 17/31 [00:02<00:02, 6.81it/s]
reward: -5.8613, last reward: -4.6345, gradient norm: 27.46: 55%|█████▍ | 17/31 [00:02<00:02, 6.81it/s]
reward: -5.8613, last reward: -4.6345, gradient norm: 27.46: 58%|█████▊ | 18/31 [00:02<00:01, 6.77it/s]
reward: -5.8230, last reward: -6.0143, gradient norm: 33.68: 58%|█████▊ | 18/31 [00:02<00:01, 6.77it/s]
reward: -5.8230, last reward: -6.0143, gradient norm: 33.68: 61%|██████▏ | 19/31 [00:02<00:01, 6.77it/s]
reward: -5.7731, last reward: -5.6127, gradient norm: 25.3: 61%|██████▏ | 19/31 [00:02<00:01, 6.77it/s]
reward: -5.7731, last reward: -5.6127, gradient norm: 25.3: 65%|██████▍ | 20/31 [00:02<00:01, 6.76it/s]
reward: -5.8158, last reward: -5.7852, gradient norm: 13.66: 65%|██████▍ | 20/31 [00:03<00:01, 6.76it/s]
reward: -5.8158, last reward: -5.7852, gradient norm: 13.66: 68%|██████▊ | 21/31 [00:03<00:01, 6.77it/s]
reward: -5.9687, last reward: -4.9258, gradient norm: 10.83: 68%|██████▊ | 21/31 [00:03<00:01, 6.77it/s]
reward: -5.9687, last reward: -4.9258, gradient norm: 10.83: 71%|███████ | 22/31 [00:03<00:01, 6.79it/s]
reward: -5.9617, last reward: -4.2573, gradient norm: 1.98: 71%|███████ | 22/31 [00:03<00:01, 6.79it/s]
reward: -5.9617, last reward: -4.2573, gradient norm: 1.98: 74%|███████▍ | 23/31 [00:03<00:01, 6.78it/s]
reward: -6.1261, last reward: -7.9520, gradient norm: 53.99: 74%|███████▍ | 23/31 [00:03<00:01, 6.78it/s]
reward: -6.1261, last reward: -7.9520, gradient norm: 53.99: 77%|███████▋ | 24/31 [00:03<00:01, 6.82it/s]
reward: -6.1183, last reward: -7.9438, gradient norm: 1.678: 77%|███████▋ | 24/31 [00:03<00:01, 6.82it/s]
reward: -6.1183, last reward: -7.9438, gradient norm: 1.678: 81%|████████ | 25/31 [00:03<00:00, 6.84it/s]
reward: -5.9948, last reward: -8.6588, gradient norm: 12.05: 81%|████████ | 25/31 [00:03<00:00, 6.84it/s]
reward: -5.9948, last reward: -8.6588, gradient norm: 12.05: 84%|████████▍ | 26/31 [00:03<00:00, 6.85it/s]
reward: -6.2913, last reward: -7.3637, gradient norm: 4.09: 84%|████████▍ | 26/31 [00:03<00:00, 6.85it/s]
reward: -6.2913, last reward: -7.3637, gradient norm: 4.09: 87%|████████▋ | 27/31 [00:03<00:00, 6.85it/s]
reward: -6.2270, last reward: -7.3009, gradient norm: 13.6: 87%|████████▋ | 27/31 [00:04<00:00, 6.85it/s]
reward: -6.2270, last reward: -7.3009, gradient norm: 13.6: 90%|█████████ | 28/31 [00:04<00:00, 6.84it/s]
reward: -6.1598, last reward: -8.9761, gradient norm: 8.041: 90%|█████████ | 28/31 [00:04<00:00, 6.84it/s]
reward: -6.1598, last reward: -8.9761, gradient norm: 8.041: 94%|█████████▎| 29/31 [00:04<00:00, 6.81it/s]
reward: -6.0858, last reward: -7.5394, gradient norm: 2.045: 94%|█████████▎| 29/31 [00:04<00:00, 6.81it/s]
reward: -6.0858, last reward: -7.5394, gradient norm: 2.045: 97%|█████████▋| 30/31 [00:04<00:00, 6.79it/s]
reward: -6.0550, last reward: -8.1112, gradient norm: 8.922: 97%|█████████▋| 30/31 [00:04<00:00, 6.79it/s]
reward: -6.0550, last reward: -8.1112, gradient norm: 8.922: 100%|██████████| 31/31 [00:04<00:00, 6.77it/s]
reward: -6.0550, last reward: -8.1112, gradient norm: 8.922: 100%|██████████| 31/31 [00:04<00:00, 6.82it/s]
```
...
[`check_env_specs()`](../reference/generated/torchrl.envs.check_env_specs.html#torchrl.envs.check_env_specs);
...
[`Download Jupyter notebook: pendulum.ipynb`](../_downloads/36eee5b78ddb0e674d19a3401b49da68/pendulum.ipynb)

[`Download Python source code: pendulum.py`](../_downloads/1733bffa19a7512167fc72ec36d6e07a/pendulum.py)

[`Download zipped: pendulum.zip`](../_downloads/cf5ed21c138297680764e29dffa8a8af/pendulum.zip)
