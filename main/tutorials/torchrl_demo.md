...
Collected batch: torch.Size([200]), reward: -7.99
Collected batch: torch.Size([200]), reward: -8.90
Collected batch: torch.Size([200]), reward: -8.91
```
...
```
Prioritized sample indices: tensor([47, 62, 49, 18, 41]) ...
```
