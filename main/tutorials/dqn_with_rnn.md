...
When the [`step_mdp()`](../reference/generated/torchrl.envs.step_mdp.html#torchrl.envs.step_mdp) function is called, the recurrent states
...
The [`StepCounter`](../reference/generated/torchrl.envs.transforms.StepCounter.html#torchrl.envs.transforms.StepCounter) transform is accessory. Since the CartPole
...
- [`InitTracker`](../reference/generated/torchrl.envs.transforms.InitTracker.html#torchrl.envs.transforms.InitTracker) will stamp the
...
Our policy will have 3 components: a [`ConvNet`](../reference/generated/torchrl.modules.ConvNet.html#torchrl.modules.ConvNet)
backbone, an [`LSTMModule`](../reference/generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule) memory layer and a shallow
[`MLP`](../reference/generated/torchrl.modules.MLP.html#torchrl.modules.MLP) block that will map the LSTM output onto the
action values.
...
that will squash the output in a vector of size 64. The [`ConvNet`](../reference/generated/torchrl.modules.ConvNet.html#torchrl.modules.ConvNet)
...
TorchRL provides a specialized [`LSTMModule`](../reference/generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule) class
...
our [`LSTMModule`](../reference/generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule) changes this default
...
arguments) to make sure that a call to [`step_mdp()`](../reference/generated/torchrl.envs.step_mdp.html#torchrl.envs.step_mdp) will
...
The Q-Value module [`QValueModule`](../reference/generated/torchrl.modules.QValueModule.html#torchrl.modules.QValueModule)
...
TorchRL also provides a wrapper class [`torchrl.modules.QValueActor`](../reference/generated/torchrl.modules.QValueActor.html#torchrl.modules.QValueActor) that
wraps a module in a Sequential together with a [`QValueModule`](../reference/generated/torchrl.modules.QValueModule.html#torchrl.modules.QValueModule)
...
progressively to 0.
This decay is achieved via a call to [`step()`](../reference/generated/torchrl.modules.EGreedyModule.html#torchrl.modules.EGreedyModule.step)
...
[`LSTMModule`](../reference/generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule) or [`GRUModule`](../reference/generated/torchrl.modules.GRUModule.html#torchrl.modules.GRUModule)
forward call. If you need to control this manually, the RNN modules are sensitive
to a context manager/decorator, [`set_recurrent_mode`](../reference/generated/torchrl.modules.set_recurrent_mode.html#torchrl.modules.set_recurrent_mode),
...
the [`DQNLoss`](../reference/generated/torchrl.objectives.DQNLoss.html#torchrl.objectives.DQNLoss) and the [`QValueModule`](../reference/generated/torchrl.modules.QValueModule.html#torchrl.modules.QValueModule)
...
rather than independent transitions. We'll use a [`SliceSampler`](../reference/generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler)
...
We'll use a [`LazyMemmapStorage`](../reference/generated/torchrl.data.replay_buffers.LazyMemmapStorage.html#torchrl.data.replay_buffers.LazyMemmapStorage) storage to keep the data
...
The [collector trajectory assembly tutorial](collector_trajectory_assembly.html#collector-trajectory-assembly)
...
```
0%| | 0/200 [00:00<?, ?it/s]
 25%|██▌ | 50/200 [00:00<00:01, 122.50it/s]
 50%|█████ | 100/200 [00:00<00:00, 125.14it/s]
 75%|███████▌ | 150/200 [00:01<00:00, 125.22it/s]
...
[`Download Python source code: dqn_with_rnn.py`](../_downloads/dde09d3c1d4412e9da159191e4ac8de2/dqn_with_rnn.py)

[`Download zipped: dqn_with_rnn.zip`](../_downloads/50b0715662e94f3a49e303bdc1969a80/dqn_with_rnn.zip)
