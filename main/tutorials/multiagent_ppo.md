...
using [LIDAR sensors](https://en.wikipedia.org/wiki/Lidar) to avoid collisions among each other.

![Navigation](https://pytorch.s3.amazonaws.com/torchrl/github-artifacts/img/navigation.gif)
...
- How we can use [`tensordict.TensorDict`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict) to carry multi-agent data;
...
![On-policy learning](https://pytorch.s3.amazonaws.com/torchrl/github-artifacts/img/on_policy_vmas.png)
...
[doc section](../reference/envs_multiagent.html#marl-environment-api).
...
adequate.
In our example, the [`VmasEnv`](../reference/generated/torchrl.envs.VmasEnv.html#torchrl.envs.VmasEnv) takes care of setting the proper specs for your env so
...
**Third**: wrap the `TensorDictModule` in a [`ProbabilisticActor`](../reference/generated/torchrl.modules.tensordict_module.ProbabilisticActor.html#torchrl.modules.tensordict_module.ProbabilisticActor)

We now need to build a distribution out of the location and scale of our
normal distribution. To do so, we instruct the [`ProbabilisticActor`](../reference/generated/torchrl.modules.tensordict_module.ProbabilisticActor.html#torchrl.modules.tensordict_module.ProbabilisticActor)
...
[`TanhNormal`](../reference/generated/torchrl.modules.TanhNormal.html#torchrl.modules.TanhNormal) distribution constructor keyword arguments (loc and scale).
...
[`ClipPPOLoss`](../reference/generated/torchrl.objectives.ClipPPOLoss.html#torchrl.objectives.ClipPPOLoss) class. This is the easiest way of utilising PPO:
...
episode_reward_mean = -0.7070456743240356: 20%|██ | 1/5 [00:05<00:21, 5.43s/it]
episode_reward_mean = 0.2768556475639343: 40%|████ | 2/5 [00:10<00:16, 5.43s/it]
episode_reward_mean = 0.898238480091095: 60%|██████ | 3/5 [00:16<00:10, 5.43s/it]
episode_reward_mean = 1.3942968845367432: 80%|████████ | 4/5 [00:21<00:05, 5.44s/it]
episode_reward_mean = 1.677427887916565: 100%|██████████| 5/5 [00:27<00:00, 5.42s/it]
```
...
![Episode reward mean](../_images/sphx_glr_multiagent_ppo_001.png)
...
MADDPG/IDDPG in PettingZoo/VMAS with multiple agent groups: [Competitive Multi-Agent Reinforcement Learning (DDPG) with TorchRL Tutorial](multiagent_competitive_ddpg.html).
...
**Total running time of the script:** (0 minutes 27.336 seconds)

[`Download Jupyter notebook: multiagent_ppo.ipynb`](../_downloads/a977047786179278d12b52546e1c0da8/multiagent_ppo.ipynb)

[`Download Python source code: multiagent_ppo.py`](../_downloads/f40bd467562dfb87148a8df03c1efb7a/multiagent_ppo.py)

[`Download zipped: multiagent_ppo.zip`](../_downloads/895258fb3cdda4392121339635f09c16/multiagent_ppo.zip)
